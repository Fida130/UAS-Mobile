...
class TabunganAdapter (val dataTabungan: ArrayList<MoneyModel>, var activity: Activity) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val tanggalTextView = rowView.findViewById(R.id.txtDateTimeList) as TextView
        ...
        akunTextView.text =tabungan.akun
        jenisTransaksiTextView.text = tabungan.jenisTransaksi
        tanggalTextView.text =tabungan.tanggal
        timeTextView.text =tabungan.time
